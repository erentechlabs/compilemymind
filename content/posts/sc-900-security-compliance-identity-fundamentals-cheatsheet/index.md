...
Focus on shared responsibility, Zero Trust, defense in depth, encryption, hashing, GRC, authentication, authorization, identity providers, and federation.

Checkpoint: you can explain why identity is now treated as the primary perimeter.

### Day 2 - Microsoft Entra

Study identity types, Entra ID, MFA, passwordless, SSPR, Conditional Access, roles, RBAC, PIM, access reviews, and Identity Protection.

Checkpoint: you can read a sign-in scenario and choose the right identity control.

### Day 3 - Security Solutions

Study Azure security services, Defender for Cloud, CSPM, Sentinel, and Defender XDR.

Checkpoint: you can separate firewall/WAF/NSG/Bastion/DDoS and explain Sentinel versus Defender XDR.

### Day 4 - Compliance Solutions

Study Service Trust Portal, Purview, Compliance Manager, sensitivity labels, DLP, records management, retention, insider risk, eDiscovery, and audit.

Checkpoint: you can distinguish DLP, sensitivity labels, retention, eDiscovery, and audit.

### Day 5 - Review With Scenarios

Use the service selection matrix above. For each scenario, ask:

1. Is the problem about **identity and access**?
2. Is it about **cloud security posture or workload protection**?
3. Is it about **SOC monitoring and response**?
4. Is it about **data governance or compliance evidence**?

That routing usually reveals the answer.

---

## Final Takeaway

SC-900 is not only a security vocabulary exam. It is a map of how Microsoft thinks about modern security:

- **Identity** is the front door.
- **Zero Trust** is the access philosophy.
- **Defense in depth** is the control design.
- **Microsoft Entra** verifies and governs identities.
- **Defender** protects workloads, endpoints, email, identities, and cloud apps.
- **Sentinel** centralizes security operations.
- **Purview** governs, protects, retains, discovers, and audits data.

If you can explain those relationships, you are no longer memorizing product names. You are thinking in security architecture.
